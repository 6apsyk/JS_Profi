...
const basketCounterEl = document.querySelector('.old-counter')
...
const goodListt = new GoodList(API.fetch());
// console.log(goodList);
const nameProduct = goodListt.get().map(name =>{
    return name.title
});
const priceProduct = goodListt.get().map(price =>{
    return price.price
});
